...
The marginal proximal effect of FTS interventions at time $$t$$, averaging over all DTRs, is
...
We apply the method to the M-Bridge study, a hybrid SMART-MRT aimed at reducing binge drinking among first-year college students. The analysis reveals potential synergistic effects between the timing of personalized normative feedback (early vs. late) and the type of self-monitoring prompt (self-interest vs. pro-social), with effects that vary over time. Code to reproduce the simulations is available at [github.com/limengbinggz/ddtlcm](https://github.com/limengbinggz/ddtlcm). For full details, proofs, and the M-Bridge application, see the paper: [Evaluating time-varying treatment effects in hybrid SMART-MRT designs](https://arxiv.org/abs/2602.21383) (arXiv:2602.21383).
